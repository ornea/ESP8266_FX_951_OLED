void handle_pid_data_only()
{
  ...
  server.sendContent(F("<div id='main'>"
                       "Temperature PID controller.&nbsp;<br>"
                       "&emsp;ticks&emsp;&emsp;,&emsp;&#176;C&emsp;&nbsp;, error&emsp;, pTerm&nbsp; , ITerm&nbsp;&nbsp; , dTerm&nbsp;&nbsp; , MV&nbsp;,&emsp;&nbsp;Millis&emsp;&nbsp;&nbsp; , %Hum,&nbsp;State"
                       "</div>"
                       ...
                       "var msg=e.data;"
                       "if(msg.indexOf('"KEY_PAIR_PREAMBLE"') == 0){" //is the first char the preamble
                       "msg = msg.slice(2);"
